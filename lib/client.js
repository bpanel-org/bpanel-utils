...
class BPClient extends Client {
  ...
  setClientInfo(id, chain) {
    ...
    this.emit('set clients', this.options);
    return this;
  }
  ...
  setNodeClient(_path = null) {
    ...
    this.emit('set node', { ...options, id: this.id, chain: this.chain });
  }
  ...
  setWalletClient(_path = null) {
    ...
    this.emit('set wallet', { ...options, id: this.id, chain: this.chain });
  }
  ...
  setMultisigClient(_path = null) {
    ...
    this.emit('set multisig', { ...options, id: this.id, chain: this.chain });
  }
